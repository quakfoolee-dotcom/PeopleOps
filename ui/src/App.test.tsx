...
const healthPayload = {
  ...
  components: {
    ...
    mcp: { status: "ready", detail: "8 tools serve Phase 7 workflows." },
  },
};
...
describe("PeopleOps Assistant Phase 7 interface", () => {
  afterEach(() => {
    cleanup();
    vi.unstubAllGlobals();
  });
  ...
  it("shows the product identity and live milestone state", async () => {
    ...
    expect(screen.getByText(/Phase 7 · v0.4.0/i)).toBeInTheDocument();
